...
class Usuario
{
    ...
    public static function constructorParametrizado($nombre = "Sin nombre", $apellido = "Sin apellido", $clave, $mail, $localidad = "Sin localidad", $fechaDeRegistro = "Sin fecha")
    {
        $user = new Usuario();
        ...
        $user->fechaDeRegistro = $fechaDeRegistro;
    ...
    public static function VerificarUsuarioDB($user)
    {
        ...
        foreach($arrayUsuarios as $usuario)
        {
            //echo $usuario->mail." user:".$user->mail;
